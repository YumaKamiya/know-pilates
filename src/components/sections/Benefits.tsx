...
function BenefitIcon({ icon }: { icon?: string }) {
  ...
  return (
    <div className="w-14 h-14 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center mb-4">
      {icon && iconMap[icon] ? (
        iconMap[icon]
      ) : (
        <svg
  ...
  return (
    <section id="benefits" className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <SectionTitle
          title="ピラティスで得られる6つの効果"
          subtitle="続けることで、体も心も変わっていきます。"
        />
